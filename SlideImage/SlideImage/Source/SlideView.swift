...
@objc
public protocol SlideViewDataSource: NSObjectProtocol {
...
@objc
public protocol SlideViewDelegate: NSObjectProtocol {
    
    /// Asks the delegate if the item should be highlighted during tracking.
    @objc(pagerView:shouldHighlightItemAtIndex:)
    optional func pagerView(_ pagerView: SlideView, shouldHighlightItemAt index: Int) -> Bool
    
    /// Tells the delegate that the item at the specified index was highlighted.
    @objc(pagerView:didHighlightItemAtIndex:)
    optional func pagerView(_ pagerView: SlideView, didHighlightItemAt index: Int)
    
    /// Asks the delegate if the specified item should be selected.
    @objc(pagerView:shouldSelectItemAtIndex:)
    optional func pagerView(_ pagerView: SlideView, shouldSelectItemAt index: Int) -> Bool
    
    /// Tells the delegate that the item at the specified index was selected.
    @objc(pagerView:didSelectItemAtIndex:)
    optional func pagerView(_ pagerView: SlideView, didSelectItemAt index: Int)
    ...
    optional func pagerView(_ pagerView: SlideView, willDisplay cell: SlideViewCell, forItemAt index: Int)
    ...
    optional func pagerView(_ pagerView: SlideView, didEndDisplaying cell: SlideViewCell, forItemAt index: Int)
    
    /// Tells the delegate when the pager view is about to start scrolling the content.
    @objc(pagerViewWillBeginDragging:)
    optional func pagerViewWillBeginDragging(_ pagerView: SlideView)
    
    /// Tells the delegate when the user finishes scrolling the content.
    @objc(pagerViewWillEndDragging:targetIndex:)
    optional func pagerViewWillEndDragging(_ pagerView: SlideView, targetIndex: Int)
    
    /// Tells the delegate when the user scrolls the content view within the receiver.
    @objc(pagerViewDidScroll:)
    optional func pagerViewDidScroll(_ pagerView: SlideView)
    
    /// Tells the delegate when a scrolling animation in the pager view concludes.
    @objc(pagerViewDidEndScrollAnimation:)
    optional func pagerViewDidEndScrollAnimation(_ pagerView: SlideView)
    
    /// Tells the delegate that the pager view has ended decelerating the scrolling movement.
    @objc(pagerViewDidEndDecelerating:)
    optional func pagerViewDidEndDecelerating(_ pagerView: SlideView)
    
}

@IBDesignable
open class SlideView: UIView,UICollectionViewDataSource,UICollectionViewDelegate {
    
    // MARK: - Public properties

    /// The object that acts as the data source of the pager view.
    @IBOutlet open weak var dataSource: SlideViewDataSource?
    
    /// The object that acts as the delegate of the pager view.
    @IBOutlet open weak var delegate: SlideViewDelegate?
    
    /// The scroll direction of the pager view. Default is horizontal.
    @objc
    open var scrollDirection: SlideView.ScrollDirection = .horizontal {
        didSet {
    ...
    @objc
    open var transformer: SlideViewTransformer? {
        didSet {
    ...
    internal weak var collectionViewLayout: SlideViewLayout!
    internal weak var collectionView: SlideCollectionView!
    ...
    public func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        let index = indexPath.item % self.numberOfItems
        function(self,cell as! SlideViewCell,index)
    }
    ...
    open func dequeueReusableCell(withReuseIdentifier identifier: String, at index: Int) -> SlideViewCell {
        ...
        guard cell.isKind(of: SlideViewCell.self) else {
            fatalError("Cell class must be subclass of FSPagerViewCell")
        }
        return cell as! SlideViewCell
    }
    ...
    @objc(indexForCell:)
    open func index(for cell: SlideViewCell) -> Int {
    ...
    open func cellForItem(at index: Int) -> SlideViewCell? {
        let indexPath = self.nearbyIndexPath(for: index)
        return self.collectionView.cellForItem(at: indexPath) as? SlideViewCell
    }
    ...
    fileprivate func commonInit() {
        ...
        // UICollectionView
        let collectionViewLayout = SlideViewLayout()
        let collectionView = SlideCollectionView(frame: CGRect.zero, collectionViewLayout: collectionViewLayout)
