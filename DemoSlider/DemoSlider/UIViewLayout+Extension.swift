...
extension UIView {
    ...
    func setShadow(color: UIColor =  UIColor.gray.withAlphaComponent(0.5), shadowOffset: CGSize = CGSize(width: 0, height: 3), shadowOpacity: Float = 1, shadowRadius: CGFloat = 2.5) {
